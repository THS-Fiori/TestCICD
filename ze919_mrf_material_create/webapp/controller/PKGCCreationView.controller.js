sap.ui.define([
    ...
    function (Controller,formatter,MessageBox,Fragment,Filter,FilterOperator) {
        ...
        return Controller.extend("ze919mrfmaterialcreate.ze919mrfmaterialcreate.controller.PKGCCreationView", {
            onInit: function () {
                this._oRouter = this.getOwnerComponent().getRouter();
                this._oRouter.getRoute("RoutePKGCCreate").attachMatched(this._onRouteMatched, this);
            },
