sap.ui.define([
    ...
    function (Controller,formatter,MessageBox,Fragment,Filter,FilterOperator) {
        ...
        return Controller.extend("ze919mrfmaterialcreate.ze919mrfmaterialcreate.controller.WIPCreationView", {
            onInit: function () {
                this._oRouter = this.getOwnerComponent().getRouter();
                this._oRouter.getRoute("RouteWIPCreate").attachMatched(this._onRouteMatched, this);
            },
