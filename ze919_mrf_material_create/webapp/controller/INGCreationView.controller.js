sap.ui.define([
    ...
    function (Controller,formatter,MessageBox,Fragment,Filter,FilterOperator) {
        ...
        return Controller.extend("ze919mrfmaterialcreate.ze919mrfmaterialcreate.controller.INGCreationView", {
            onInit: function () {
                this._oRouter = this.getOwnerComponent().getRouter();
                this._oRouter.getRoute("RouteINGCreate").attachMatched(this._onRouteMatched, this);
            },
