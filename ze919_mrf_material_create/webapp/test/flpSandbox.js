		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MRF Form",
									"targetURL": "#ze919mrfmaterialcreateze919mrfmaterialcreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ze919mrfmaterialcreateze919mrfmaterialcreate-display": {
								"semanticObject": "ze919mrfmaterialcreateze919mrfmaterialcreate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ze919mrfmaterialcreate.ze919mrfmaterialcreate",
									"url": sap.ui.require.toUrl("ze919mrfmaterialcreate/ze919mrfmaterialcreate")
								}
							}
						}
					}
